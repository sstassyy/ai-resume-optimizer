...
INSERT INTO "new_Resume" ("contentJson", "createdAt", "id", "parentResumeId", "sourceFileUrl", "title", "userId", "version") SELECT "contentJson", "createdAt", "id", "parentResumeId", "sourceFileUrl", "title", "userId", "version" FROM "Resume";
DROP TABLE "Resume";
